...
ezButton start_button(2);                                   // Button start_stop for activation/parking
ezButton scoop_pour(3);                                   // Button pause_resume for scooping action
ezButton stop_button(4);                               // Button emergency_stop for stopping the system in the middle of the operation  
...
void setup() 
{
  ...
  start_button.setDebounceTime(50);                           //Set button debounce time 50 ms (custom) for false click protection
  scoop_pour.setDebounceTime(50);
  stop_button.setDebounceTime(50);

  start_button.setCountMode(COUNT_FALLING);
  scoop_pour.setCountMode(COUNT_FALLING);
  stop_button.setCountMode(COUNT_FALLING);
...
void loop() {
    ...
    switch (buttonState)
    {
        ...
        case 2:
            ...
            {
              Serial.println("Activate the system first");
            }
